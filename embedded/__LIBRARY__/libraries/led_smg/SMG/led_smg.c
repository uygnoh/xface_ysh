...
void smg_more_window_display(void)
{
	...
	case 0:                         //__窗口__1
		...
		led_buf[2] = parm1/10;  //第三个数码管显示“十位”
		led_buf[3] = parm1%10;  //第四个数码管显示“个位”
		for (i = 0; i < 5000; i++) {
	...
	case 1:                         //__窗口__2
		...
		led_buf[1] = 22;        //第二个数码管显示“-”
		led_buf[2] = parm2/10;  //第三个数码管显示“十位”
		led_buf[3] = parm2%10;  //第四个数码管显示“个位”
		for (i = 0; i < 5000; i++) {
			smg_display();  //动态刷新四个数码管显示“”
		}
		window++;               //跳转到下一个窗口
	...
	case 2:                         //__窗口__3
		...
		led_buf[1] = 22;        //第二个数码管显示“-”
		led_buf[2] = parm3/10;  //第三个数码管显示“十位”
		led_buf[3] = parm3%10;  //第四个数码管显示“个位”
		for (i = 0; i < 5000; i++)
			smg_display();  //动态刷新四个数码管显示“”
		window++;               //跳转到下一个窗口
		break;
	case 3:                         //__窗口__4
		...
		led_buf[1] = 22;        //第二个数码管显示“-”
		led_buf[2] = parm4/10;  //第三个数码管显示“十位”
		led_buf[3] = parm4%10;  //第四个数码管显示“个位”
		for (i = 0; i < 5000; i++) {
			smg_display();  //动态刷新四个数码管显示“”
		}
		window = 0;             //跳转到第一个窗口
