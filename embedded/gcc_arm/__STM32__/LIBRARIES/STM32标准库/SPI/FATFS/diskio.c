...
#define ATA                     0       // 物理存储介质的编号
#define SPI_FLASH               1       // 物理存储介质的编号
...
DSTATUS disk_status(BYTE pdrv)  
{
        ...
        case SPI_FLASH :
                if (spi_flash_read_id() == W25Q_FLASH_ID) {
                        stat = 0;          // W25Q_FLASH 状态正常
                } else {                  // W25Q_FLASH 状态（不）正常，初始化失败
                        stat = STA_NOINIT;
                }
                return stat;
        default:
        ...
        UINT count)             // Number of sectors to read
{
        ...
        case SPI_FLASH :
                ...
                spi_read_buffer(buff, sector*4096, count*4096);
                res = RES_OK;
                return res;
        default:
                return STA_NOINIT;
        ...
        UINT count)             // Number of sectors to write
{
        ...
        case SPI_FLASH :
                ...
                // 先擦除，再写入
                spi_erase_sector(sector*4096);
                spi_write_buffer((uint8_t *)buff, sector*4096, count*4096);
                res = RES_OK;
                return res;
        default:
                return STA_NOINIT;
