...
enum {
       HOS_CMD_STREAM_USER0 = ((0) + HOS_CMD_STREAM_USER),
...
static
HOS_STATE_ENUM_T hos_privatehos_run(struct __hos *hos)
{
        int bstop = 0;
        HOS_STATE_ENUM_T state;
        HOS_UNIT_STRUCT_T *punit = 
# 17 "module1.c" 3 4
                                  ((void *)0)
# 17 "module1.c"
                                      ;
...
static
int hos_privateHOS_CMD_STREAM_BUFCHANGED(struct __hos *hos, char *buf)
{
        HOS_UNIT_STRUCT_T *punit = 
# 56 "module1.c" 3 4
                                  ((void *)0)
...
static
int hos_privateHOS_CMD_STREAM_START(struct __hos *hos, HOS_FILE_STRUCT_T *file)
{
        int res;
        HOS_UNIT_STRUCT_T *punit = 
# 83 "module1.c" 3 4
...
# 133 "module1.c"
                ...
                int res = hos_command(punit->hos_submodule, HOS_CMD_STREAM_STOP, 
# 134 "module1.c" 3 4
                                                                                ((void *)0)
# 134 "module1.c"
                                                                                    );
...
static
int hos_privatehos_command(struct __hos *hos, int cmd, void *params)
{
        int ret = 0;
        HOS_UNIT_STRUCT_T *punit = 
# 151 "module1.c" 3 4
...
# 156 "module1.c"
        ...
        case HOS_CMD_STREAM_START:
                ...
                return hos_privateHOS_CMD_STREAM_START(os, (HOS_FILE_STRUCT_T *)params);
                break;
        ...
        case HOS_CMD_STREAM_STOP:
                ...
                return (hos_privateHOS_CMD_STREAM_STOP(hos));
                break;
        case HOS_CMD_STREAM_BUFCHANGED:
                return (hos_privateHOS_CMD_STREAM_BUFCHANGED(hos, (char *)params));
                break;
        default:
...
static
void hos_privatehos_deinit(struct __hos *hos)
{
        HOS_UNIT_STRUCT_T *punit = 
# 196 "module1.c" 3 4
                                  ((void *)0)
...
static
HOSHANDLE hos_privatehos_init(struct __hos *hos)
{
        int res;
...
# 217 "module1.c"
        ...
        punit->hos = hos;
        hos->hos_run = &hos_privatehos_run;
        hos->hos_command = &hos_privatehos_command;
        hos->hos_deinit = &hos_privatehos_deinit;
        hos->state = HOS_STATE_INITED;
...
struct __hos ghos_module1 = {
        "module1", (1 << HOS_MODULE01), &hos_privatehos_init,
};
