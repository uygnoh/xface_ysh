...
/*******************************************************************************
  函数名称: void clock_setup_hsi_8mhz(void)
  输入参数: 无
  输出参数: 无
  函数功能: 将系统时钟重置为（默认状态）
*******************************************************************************/
...
/*******************************************************************************
  函数名称: void clock_setup_hse_8mhz_to_72mhz(void)
  输入参数: 无
  输出参数: 无
  函数功能: 系统时钟由外部高速8MHz晶振 -> 经过PLL倍频到72MHz -> 供给系统
*******************************************************************************/
void clock_setup_hse_8mhz_to_72mhz(void)
{
