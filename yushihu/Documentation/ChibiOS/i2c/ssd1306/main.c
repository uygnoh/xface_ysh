...
static __attribute__((noreturn)) THD_FUNCTION(OledDisplay, arg)
{
        ...
        while (TRUE) {
                ...
                sprintf(snum0, "PA6 %d.%.2d", (int16_t) fADCreading,
                        (int8_t) ((fADCreading-(int16_t)fADCreading)*100.0));  // gives 2 decimal places
                ...
                sprintf(snum1, "PA7 %d.%.2d", (int16_t) fADCreading,
                        (int8_t) ((fADCreading-(int16_t)fADCreading)*100.0));  // gives 2 decimal places
                ...
                //	sprintf(ionnum, "PA7 %d.%.2d", (int16_t) fADCreading,
                //      (int8_t) ((fADCreading-(int16_t)fADCreading)*100.0));  // gives 2 decimal places
