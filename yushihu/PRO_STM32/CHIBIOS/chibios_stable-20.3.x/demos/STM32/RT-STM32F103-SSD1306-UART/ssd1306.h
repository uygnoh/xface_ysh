...
// SSD1306 着色   |   SSD1306 地址   
// SSD1306 状态   |  SSD1306 字体状态    |   SSD1306 配置
...
typedef struct SSD1306Driver {                  // SSD1306 程序驱动结构
        const struct SSD1306VMT *vmt;           // SSD1306 功能
        _ssd1306_data;                           // SSD1306 配置
